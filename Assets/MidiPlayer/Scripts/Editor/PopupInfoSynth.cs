    ...
    public class PopupInfoSynth : EditorWindow
    {
        ...
        void OnGUI()
        {
            try
            {
                ...
                string modeSynth = "Synth: " + MidiSynth.name + " Mode: " + (MidiSynth.MPTK_CorePlayer ? "Core" : "AudioSource");
                ...
                info += $"Voice:\tPlayed:{ MidiSynth.MPTK_StatVoicePlayed,-4}\tFree:{ MidiSynth.MPTK_StatVoiceCountFree,-4}\tActive:{MidiSynth.MPTK_StatVoiceCountActive,-4}\t";
                info += $"Reused:{Mathf.RoundToInt(MidiSynth.MPTK_StatVoiceRatioReused)} %\n";
