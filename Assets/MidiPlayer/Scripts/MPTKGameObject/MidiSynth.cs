...
namespace MidiPlayerTK
{
    ...
    public partial class MidiSynth : MonoBehaviour
    {
        ...
        /// @code
        /// 
        /// // Somewhere in your script, for example in the Start() method:
        /// 
        ///     // triggered StartPlay(string midiname) when the MIDI starts playing (Indeed, will be triggered at every beginning of loop)
